...
test('table content visible', () => {
  render(withTheme(
    <Table>
      <TableHeader><TableRow><TableCell>ID</TableCell></TableRow></TableHeader>
      <tbody><TableRow><TableCell>1</TableCell></TableRow></tbody>
...
test('table cell disabled attribute exists', () => {
  render(withTheme(<table><tbody><TableRow><TableCell disabled>X</TableCell></TableRow></tbody></table>));
